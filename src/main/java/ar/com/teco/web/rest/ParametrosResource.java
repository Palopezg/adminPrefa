...
/**
 * REST controller for managing {@link ar.com.teco.domain.Parametros}.
 */
@RestController
@RequestMapping("/api")
public class ParametrosResource {
    ...
    public ResponseEntity<Parametros> updateParametros(@Valid @RequestBody Parametros parametros) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, parametros.getId().toString()))
            .body(result);
    }
